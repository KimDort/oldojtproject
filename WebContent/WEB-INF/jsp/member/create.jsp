				...
				<table class="table table-hover" style="width: 100%;">
					...
					<tbody>
						<tr>
							...
							<td>
								<input type="text" placeholder="Please Write Name" class="form-control" name="name" id="name">
							</td>
							<th>Company</th>
							<td>
						...
						<tr>
							...
							<td>
								<input type="text" name="joincompany" class="form-control" readonly="readonly" id="joincompany">
							</td>
							<th>
								Out Company Date
							</th>
							<td>
								<input type="text" name="outcompany" class="form-control" readonly="readonly" id="outcompany">
							</td>
						</tr>
						<tr>
							<th>
						...
						<tr>
							...
							<td colspan="3">
								<input type="text" name="haveskills" class="form-control" id="skills" placeholder="JAVA, SPRING, ...">
							</td>
						...
						<tr>
							...
							<td colspan="3">
								<input type="text" name="idnumber1" class="form-control" maxlength="6" id="idnumber1" placeholder="123456">&nbsp;-
								<input type="password" name="idnumber2" class="form-control" maxlength="7" id="idnumber2" placeholder="1234567">
							</td>
