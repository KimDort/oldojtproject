...
function addLicenseItem(){
	var str="<div class='col-md-12 form-inline' id='license_line'><div class='form-group'><label>Name</label>"
			+"<input type='text' class='form-control' id='license_name' name='license_name'></div><div class='form-group'>"
			+"<label>Level</label><input type='text' class='form-control' id='license_level' name='license_level'>"
			+"</div><div class='form-group'><label>Get Date</label>"
			+"<input type='text' class='form-control' name='license_date' readonly='readonly'></div>"
			+"<div class='form-group'><label>Publisher</label>"
			+"<input type='text' class='form-control' id='license_Publisher' name='license_publisher'>"
...
function addCareerItem(){
	var str="<div class='col-md-12 form-inline' id='period_line'><div class='form-group'><label>Period</label>"
			+"<input type='text' class='form-control' name='period_start' style='width:100px' readonly='readonly'>&nbsp;~"
			+"<input type='text' class='form-control' name='period_end' style='width:100px' readonly='readonly'>"
			+"</div><div class='form-group'><label>Company</label>"
			+"<input type='text' class='form-control' name='period_company' id='period_company'></div>"
			+"<div class='form-group'><label>Rank</label>"
			+"<select class='form-control' name='period_rank' id='period_rank'><option value=''></option>"
			...
			+"<input type='text' class='form-control' name='period_position' id='period_position'>"
